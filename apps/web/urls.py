...
urlpatterns = [
    ...
    path("listings/<int:listing_id>/chat/", extra_views.start_conversation, name="start_chat"),
    path("register/", views.RegisterView.as_view(), name="register"),
    path("login/", views.LoginView.as_view(), name="login"),
    path("logout/", views.LogoutView.as_view(), name="logout"),
    path("password-reset/", extra_views.CustomPasswordResetView.as_view(), name="password_reset"),
    path("password-reset/done/", extra_views.CustomPasswordResetDoneView.as_view(), name="password_reset_done"),
    path("reset/<uidb64>/<token>/", extra_views.CustomPasswordResetConfirmView.as_view(), name="password_reset_confirm"),
    path("reset/done/", extra_views.CustomPasswordResetCompleteView.as_view(), name="password_reset_complete"),
    ...
    path("messages/", extra_views.inbox, name="inbox"),
    path("messages/<int:pk>/", extra_views.conversation_detail, name="conversation"),
    ...
    path("bookings/<int:pk>/tenant-review/", extra_views.create_tenant_review, name="create_tenant_review"),

"""Shared listing search and queryset helpers."""
...
def filter_listings(qs, params, user=None):
    ...
    if params.get("instant_book") in ("1", "true", "on"):
...
def similar_listings(listing, limit=4):
    return (
...
def get_booked_date_ranges(listing_id):
